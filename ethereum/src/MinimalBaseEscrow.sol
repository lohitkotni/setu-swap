...
/**
 * @title Minimal Base Escrow contract for cross-chain atomic swap.
 * @dev Withdraw, cancel and _validateImmutables functions must be implemented in the derived contracts.
 */
abstract contract MinimalBaseEscrow is IBaseEscrow {
